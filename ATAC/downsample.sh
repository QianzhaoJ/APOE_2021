...
path=/work2/liugh/wuqiong/05_Results/08_APOE/ATAC_new/04_unique
...
#/work2/liugh/wuqiong/04_Softwares/sambamba-0.7.0-linux-static flagstat -t 24 $outbam>$outbam.log
samtools index -@ 24 $outbam
done
